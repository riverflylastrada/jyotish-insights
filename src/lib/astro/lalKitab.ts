...
const SEED: Record<Graha, Record<HouseNumber, Seed>> = {
  ...
  mars: {
    1: { nature: 'mixed',
      ...
      remedies: ["Recite the Hanuman Chalisa and worship Hanuman.", "Draw on Sun and Moon remedies (offer water to the Sun; wear a pearl in silver) and Venus remedies for marriage (feed a cow grass; donate ghee or curd)."],
    ...
    6: { nature: 'benefic',
      ...
      remedies: ["Donate milk and silver to maids; do not adorn children with gold.", "Treat Saturn — feed crows (bread for 43 days) and donate iron, oil, or black gram (urad)."] },
    7: { nature: 'malefic',
      ...
      remedies: ["Offer red clothes to your sister and paternal aunt (bua).", "Keep a solid silver ball; strengthen Saturn (feed crows; donate iron, oil, or black gram/urad)."],
  ...
  mercury: {
    ...
    10: { nature: 'mixed',
      ...
      remedies: ["Treat Saturn — feed crows, donate iron, oil, or black gram (urad), and float oil you've seen your reflection in."] },
    11: { nature: 'mixed',
  ...
  venus: {
    ...
    4: { nature: 'benefic',
      ...
      remedies: ["Treat Jupiter — donate gram dal, turmeric, or gold; apply a saffron tilak; water a peepal tree."] },
    5: { nature: 'benefic',
    ...
    10: { nature: 'benefic',
      ...
      remedies: ["Treat Saturn — feed crows, and donate iron, oil, or black gram (urad)."] },
    11: { nature: 'benefic',
  ...
  saturn: {
    ...
    9: { nature: 'mixed',
      ...
      remedies: ["Treat Jupiter — donate gram dal, turmeric, gold, or saffron; water a peepal tree."] },
    10: { nature: 'benefic',
