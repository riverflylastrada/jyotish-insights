...
export const VARGA_META: Array<{
  ...
  { code: 'D5',  name: 'Panchamsa',       sig: 'Fame, power, authority',        divisor: 5 },
  { code: 'D6',  name: 'Shashthamsa',     sig: 'Health, disease',              divisor: 6 },
  { code: 'D7',  name: 'Saptamsa',        sig: 'Children, progeny',             divisor: 7 },
  { code: 'D8',  name: 'Ashtamsa',        sig: 'Longevity, sudden events',      divisor: 8 },
  { code: 'D9',  name: 'Navamsha',        sig: 'Marriage, dharma, fruition',     divisor: 9 },
  { code: 'D10', name: 'Dasamsa',         sig: 'Career, public life',           divisor: 10 },
  { code: 'D11', name: 'Rudramsa',        sig: 'Gains, death of desires',       divisor: 11 },
